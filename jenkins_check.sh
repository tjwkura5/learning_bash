...
# Create a script that checks if Jenkins is running and 
# its associated port is open. 
# If the service is running but the port is closed, 
# attempt to open the port using firewall rules. 
# If the service is not running, start the service and open the port.
